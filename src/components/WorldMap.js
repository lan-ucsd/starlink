...
class WorldMap extends Component {
    ...
    componentDidUpdate(prevProps, prevState, snapshot) {
        ...
        if(this.props.satData !== prevProps.satData){
            ...
            // get observer data -> setting data
            ...
            axios.all(urls)
                ...
                .then(res => {
                    ...
                    if(!prevState.isDrawing) {
                        ...
                        oHint.innerHTML = 'Please wait for these satellite animations to finish before selecting new ones!'
                    }
                })
                .catch(e => {
    ...
    drawSat(sat, pos){
        ...
        if (!satlatitude || !satlatitude) return;
        const {satname} = sat;
        ...
        context2.fill();
        context2.font = "bold 11 px sans-serif";
        context2.textAlign = "center";
